        ...
        return (
            <div className="container px-4 py-12 mx-auto">
                <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="text-muted-foreground mt-2">Looks like you haven&apos;t added any perfumes to your cart yet.</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-4">
                                ...
                                <div className="flex flex-col sm:flex-row">
                                    ...
                                    <div className="p-4 flex-1 flex flex-col sm:flex-row sm:items-center">
                                        <div className="flex-1">
                                            ...
                                            <p className="font-semibold mt-1">৳ {formatBDTNumber(item.price)}</p>
                                        </div>
                    ...
                    <div className="flex justify-between items-center">
                        <Button variant="outline" onClick={clearCart} className="py-5">
                            Clear Cart
                        </Button>
                ...
                <div>
                    <Card>
                        ...
                        <CardFooter>
                            <Button asChild className="w-full bg-gray-950 py-6">
